...
abstract class Routes {
  ...
  static const ADD_TOLLS = _Paths.ADD_TOLLS;
  static const PAY_SHOP_RENT = _Paths.PAY_SHOP_RENT;
...
abstract class _Paths {
  ...
  static const ADD_TOLLS = '/add-tolls';
  static const PAY_SHOP_RENT = '/pay-shop-rent';
